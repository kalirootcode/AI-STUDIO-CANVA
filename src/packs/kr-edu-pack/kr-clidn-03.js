/**
 * KR-CLIDN-03: FEATURE CARDS / OPCIONES
 * Grid de opciones/flags con iconos neon
 */
export function render(data) {
    const d = {
        TITLE: data.TITLE || 'Opciones Esenciales',
        INTRO_TEXT: data.INTRO_TEXT || 'Las opciones más importantes que debes conocer.',
        SLIDE_NUMBER: data.SLIDE_NUMBER || '03/08',
        TIP_TITLE: data.TIP_TITLE || 'Pro Tip',
        TIP_CONTENT: data.TIP_CONTENT || 'Combina opciones para un escaneo más completo.',
        OPTIONS: data.OPTIONS || [
            { FLAG: '-sS', NAME: 'SYN Scan', ICON: 'bolt', DESCRIPTION: 'Escaneo sigiloso y rápido' },
    ...
    const optsHTML = d.OPTIONS.map(o => `
        <div class="opt-card">
            <div class="opt-header">
                <div class="opt-icon"><i class="material-icons">${o.ICON || 'code'}</i></div>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .tip-box i { color: #a855f7; font-size: 32px; margin-top: 2px; }
