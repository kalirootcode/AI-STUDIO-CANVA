/**
 * KR-CLIDN-20: CHAPTER DIVIDER
 * Separador de sección para posts largos tipo libro
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .chapter-icon .iconify { font-size: 56px; color: #2563EB; }
...
<body>
    <div class="slide">
        ...
        <div class="content">
            <div class="chapter-icon">${(d.ICON).includes(':') ? '<span class="iconify" data-icon="' + (d.ICON) + '"></span>' : '<i class="material-icons">' + (d.ICON) + '</i>'}</div>
            <div class="chapter-label">SECCIÓN</div>
            <div class="chapter-num">${d.CHAPTER_NUMBER}</div>
            <div class="line-deco"></div>
            <div class="chapter-title">${d.CHAPTER_TITLE}</div>
            <div class="chapter-subtitle">${d.CHAPTER_SUBTITLE}</div>
        </div>
