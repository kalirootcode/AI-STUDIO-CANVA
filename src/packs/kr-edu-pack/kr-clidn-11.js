/**
 * KR-CLIDN-11: COMMAND CARD
 * Tarjeta individual de un comando con ejemplo, explicación y uso
 * DISEÑADO PARA REPETIRSE — cada comando = 1 slide educativo completo
 */
export function render(data) {
    const d = {
        COMMAND_NAME: data.COMMAND_NAME || 'ls',
        COMMAND_NUMBER: data.COMMAND_NUMBER || '01',
        TOTAL_COMMANDS: data.TOTAL_COMMANDS || '30',
        CATEGORY: data.CATEGORY || 'Navegación',
        SYNTAX: data.SYNTAX || 'ls [opciones] [ruta]',
        DESCRIPTION: data.DESCRIPTION || 'Lista el contenido de un directorio.',
        EXAMPLE_CMD: data.EXAMPLE_CMD || '$ ls -la /home/user',
        EXAMPLE_OUTPUT: data.EXAMPLE_OUTPUT || 'drwxr-xr-x 5 user user 4096 ...',
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .term-bar .b:nth-child(1) { background: #ff3366; }
    ...
    <div class="slide">
        ...
        <div class="content">
            ...
            <div class="flags-section">
                <div class="flags-label">FLAGS CLAVE</div>
