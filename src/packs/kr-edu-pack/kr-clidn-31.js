 ...
 * Muestra scripts con líneas numeradas, highlighting, y explicación
 */
export function render(data) {
    ...
    const linesHTML = d.CODE_LINES.map((l, i) => {
        ...
        let cls = 'code-line';
        if (l.TYPE === 'comment') cls += ' comment';
        else if (l.TYPE === 'variable') cls += ' variable';
        else if (l.TYPE === 'command') cls += ' cmd';
        else if (l.TYPE === 'string') cls += ' str';
        else if (l.TYPE === 'keyword') cls += ' kw';
        else if (l.TYPE === 'blank') cls += ' blank';
        return `<div class="${cls}"><span class="ln">${num}</span><span class="code">${l.TEXT || '&nbsp;'}</span></div>`;
    }).join('\n');
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .editor-dots { display: flex; gap: 10px; }
        .editor-dots span { width: 14px; height: 14px; border-radius: 50%; }
        .editor-dots span:nth-child(1) { background: #ff3366; }
        .editor-dots span:nth-child(2) { background: #ff9500; }
        .editor-dots span:nth-child(3) { background: #4DD9C0; }
        ...
        .code-line:hover { background: rgba(37,99,235,0.04); }
        ...
        .code { color: #e6edf3; white-space: pre; }

        .code-line.comment .code { color: #6b7280; font-style: italic; }
        .code-line.variable .code { color: #79c0ff; }
        .code-line.cmd .code { color: #4DD9C0; font-weight: 700; }
        .code-line.str .code { color: #a5d6ff; }
        .code-line.kw .code { color: #ff7b72; }
        .code-line.blank .code { color: transparent; }
        ...
        <div class="content">
            ...
            <div class="editor">
                <div class="editor-header">
                    ...
                    <div class="lang-badge">${d.LANGUAGE}</div>
                </div>
