/**
 * KR-CLIDN-07: WARNING / ÉTICA
 * Ejercicio con advertencia de seguridad/ética importante
 */
export function render(data) {
    const d = {
        EXERCISE_LETTER: data.EXERCISE_LETTER || 'B',
        TITLE: data.TITLE || 'Precaución',
        INTRO_TEXT: data.INTRO_TEXT || 'Este ejercicio requiere cuidado especial.',
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .warning-card::before {
            ...
            background: linear-gradient(180deg, #ff3366, #ff9500);
        }
        ...
        .corner-deco {
            ...
            border-left: 2px solid rgba(255,51,102,0.15);
            border-bottom: 2px solid rgba(255,51,102,0.15);
        }
