/**
 * KR-CLIDN-05: GRID / COLUMNAS
 * Desglose de múltiples columnas o items en un grid numerado
 */
export function render(data) {
    const d = {
        ...
        OUTPUT_LINES: data.OUTPUT_LINES || [
            ...
            { TEXT: '80/tcp open  http    Apache 2.4' }
        ],
        GRID_ITEMS: data.GRID_ITEMS || [
            { NUMBER: '1', TITLE: 'PORT', CONTENT: 'Número de puerto' },
            { NUMBER: '2', TITLE: 'STATE', CONTENT: 'Estado del puerto' },
            { NUMBER: '3', TITLE: 'SERVICE', CONTENT: 'Nombre del servicio' },
            { NUMBER: '4', TITLE: 'VERSION', CONTENT: 'Versión detectada' },
            { NUMBER: '5', TITLE: 'PROTOCOL', CONTENT: 'TCP o UDP' }
        ]
    };
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .grid-title {
            ...
            color: #ff9500; margin-bottom: 4px;
        }
    ...
    <div class="slide">
        ...
        <div class="content">
            ...
            <div class="terminal">
                ...
                <div class="term-body">${outHTML}</div>
            </div>
