/**
 * KR-CLIDN-04: TERMINAL OUTPUT
 * Muestra la salida de un comando en una terminal realista
 */
export function render(data) {
    ...
    const breakHTML = d.BREAKDOWN_CARDS.map(c => `
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .term-bar .btn:nth-child(1) { background: #ff3366; }
        .term-bar .btn:nth-child(2) { background: #ff9500; }
        .term-bar .btn:nth-child(3) { background: #4DD9C0; }
