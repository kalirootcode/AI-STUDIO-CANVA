/**
 * KR-CLIDN-21: PRO TERMINAL
 * Terminal profesional realista con múltiples líneas y output colorizado
 */
export function render(data) {
    const d = {
        ...
        TERMINAL_LINES: data.TERMINAL_LINES || [
            ...
            { TYPE: 'success', TEXT: '80/tcp   open  http     Apache 2.4.52' },
            { TYPE: 'warning', TEXT: '443/tcp  open  ssl      VULNERABLE' },
            { TYPE: 'output', TEXT: 'Nmap done: 1 IP scanned in 12.34s' }
        ],
    ...
    const linesHTML = d.TERMINAL_LINES.map(l => {
        ...
        else if (l.TYPE === 'highlight') cls += ' hl';
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .terminal {
            ...
            overflow: hidden;
            margin-bottom: 36px;
            box-shadow: 0 20px 60px rgba(0,0,0,0.5), 0 0 40px rgba(77,217,192,0.05);
        }
        ...
        .term-dots span { width: 14px; height: 14px; border-radius: 50%; }
        .term-dots span:nth-child(1) { background: #ff3366; box-shadow: 0 0 8px rgba(255,51,102,0.4); }
        .term-dots span:nth-child(2) { background: #ff9500; box-shadow: 0 0 8px rgba(255,149,0,0.4); }
        .term-dots span:nth-child(3) { background: #4DD9C0; box-shadow: 0 0 8px rgba(77,217,192,0.4); }
        ...
        <div class="content">
            ...
            <div class="terminal">
                <div class="term-header">
                    ...
                    <div class="term-title">root@kali:~#</div>
                </div>
                <div class="term-body">
                    ${linesHTML}
