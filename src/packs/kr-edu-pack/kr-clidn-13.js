...
export function render(data) {
    const d = {
        ...
        SLIDE_NUMBER: data.SLIDE_NUMBER || '03/07'
    };
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ═══ STEP HEADER ═══ */
        .step-header { display: flex; align-items: center; gap: 24px; margin-bottom: 32px; }
        ...
        .note-box i { color: #a855f7; font-size: 30px; }
        ...
        <div class="content">
            <div class="step-header">
                <div class="step-badge">
                    <div class="num">${d.STEP_NUMBER}</div>
                    <div class="label">PASO</div>
                </div>
                <div class="step-meta">
                    <div class="step-counter">Paso ${d.STEP_NUMBER} de ${d.TOTAL_STEPS}</div>
                    <div class="step-title">${d.TITLE}</div>
                </div>
            </div>
