/**
 * KR-CLIDN-14: CODE BLOCK
 * Bloque de código/script completo con explicación
 */
export function render(data) {
    const d = {
        TITLE: data.TITLE || 'Script',
        LANGUAGE: data.LANGUAGE || 'bash',
        DESCRIPTION: data.DESCRIPTION || 'Descripción del script.',
        CODE_LINES: data.CODE_LINES || [
            { LINE: '#!/bin/bash', COMMENT: '' },
            { LINE: 'echo "Hello"', COMMENT: '# Saludo' }
        ],
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .explain-box i { color: #2563EB; font-size: 30px; margin-top: 2px; }
