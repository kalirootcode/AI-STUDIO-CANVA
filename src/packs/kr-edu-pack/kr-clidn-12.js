/**
 * KR-CLIDN-12: COMPARACIÓN (VS)
 * Dos conceptos, herramientas o comandos lado a lado
 */
export function render(data) {
    const d = {
        TITLE: data.TITLE || 'Comparación',
        LEFT_NAME: data.LEFT_NAME || 'Opción A',
        LEFT_ICON: data.LEFT_ICON || 'code',
        ...
        RIGHT_ICON: data.RIGHT_ICON || 'terminal',
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ═══ VS LAYOUT ═══ */
        .vs-container { display: flex; gap: 24px; margin-bottom: 36px; }
        ...
        .vs-card.left { border: 1px solid rgba(37, 99, 235, 0.2); }
        .vs-card.right { border: 1px solid rgba(77, 217, 192, 0.2); }
        ...
        .vs-card.left::before { background: linear-gradient(90deg, #2563EB, transparent); }
        .vs-card.right::before { background: linear-gradient(90deg, #4DD9C0, transparent); }

        .vs-header { display: flex; align-items: center; gap: 12px; margin-bottom: 24px; }
        ...
        .left .vs-icon { background: rgba(37,99,235,0.1); border: 1px solid rgba(37,99,235,0.2); }
        .left .vs-icon i { color: #2563EB; font-size: 32px; }
        .right .vs-icon { background: rgba(77,217,192,0.1); border: 1px solid rgba(77,217,192,0.2); }
        .right .vs-icon i { color: #4DD9C0; font-size: 32px; }
        ...
        .left .vs-item i { color: rgba(37,99,235,0.5); font-size: 28px; margin-top: 2px; }
        .right .vs-item i { color: rgba(77,217,192,0.5); font-size: 28px; margin-top: 2px; }
        ...
        .verdict i { color: #ff9500; font-size: 32px; }
            ...
            <div class="vs-wrapper">
                ...
                <div class="vs-container">
                    <div class="vs-card left">
                        <div class="vs-header">
                            <div class="vs-icon"><i class="material-icons">${d.LEFT_ICON}</i></div>
                    ...
                    <div class="vs-card right">
                        <div class="vs-header">
                            <div class="vs-icon"><i class="material-icons">${d.RIGHT_ICON}</i></div>
