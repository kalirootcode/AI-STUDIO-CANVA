...
export function render(data) {
    const d = {
        ...
        SLIDE_NUMBER: data.SLIDE_NUMBER || '02/16'
    };

    const itemsHTML = d.ITEMS.map(i => `
        <div class="toc-row">
            <div class="toc-num">${i.NUMBER}</div>
            <div class="toc-text">${i.TEXT}</div>
            <div class="toc-dots"></div>
            <div class="toc-range">${i.RANGE}</div>
        </div>`).join('\n');
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .title i { color: #2563EB; font-size: 48px; }

        .subtitle { font-size: 32px; color: #94a3b8; margin-bottom: 48px; }

        .toc { display: flex; flex-direction: column; gap: 8px; margin-bottom: 40px; }
        ...
        .toc-text { font-size: 32px; color: #e2e8f0; font-weight: 500; }
        ...
        .toc-range {
            font-family: 'JetBrains Mono', monospace;
            font-size: 26px; color: rgba(255,255,255,0.3);
        }
        ...
        .total-bar i { color: #2563EB; font-size: 30px; }
...
<body>
    <div class="slide">
        ...
        <div class="content">
            <div class="section-label">// Índice</div>
            <div class="title"><i class="material-icons">menu_book</i> ${d.TITLE}</div>
            <div class="subtitle">${d.SUBTITLE}</div>
            <div class="toc">${itemsHTML}</div>
            <div class="total-bar">
                <i class="material-icons">layers</i>
                <span>Total: <strong>${d.TOTAL_SLIDES} slides</strong></span>
            </div>
        </div>
