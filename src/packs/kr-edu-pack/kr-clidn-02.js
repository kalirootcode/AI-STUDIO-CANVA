/**
 * KR-CLIDN-02: ANATOMÍA / SINTAXIS
 * Desglosa la estructura de un comando con componentes conectados
 */
export function render(data) {
    const d = {
        TITLE: data.TITLE || 'Anatomía del Comando',
        COMMAND_STRUCTURE: data.COMMAND_STRUCTURE || 'comando [opciones] objetivo',
        SLIDE_NUMBER: data.SLIDE_NUMBER || '02/08',
        TIP: data.TIP || 'Los elementos entre [ ] son opcionales.',
        COMPONENTS: data.COMPONENTS || [
            { NUMBER: '1', NAME: 'comando', DESCRIPTION: 'El binario principal' },
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body::after {
            ...
            width: 600px;
            height: 600px;
            background: radial-gradient(circle, rgba(77, 217, 192, 0.06) 0%, transparent 70%);
        }
        ...
        .cmd-bar span:first-child { background: #ff3366; }
        .cmd-bar span:nth-child(2) { background: #ff9500; }
        .cmd-bar span:nth-child(3) { background: #4DD9C0; }
        ...
        .tip-box i { color: #2563EB; font-size: 32px; }
    ...
    <div class="slide">
        ...
        <div class="content">
            ...
            <div class="cmd-box">
                ...
                <div class="cmd-text">${d.COMMAND_STRUCTURE}</div>
            </div>
