...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .quote-icon {
            font-size: 80px; color: rgba(168,85,247,0.3);
            margin-bottom: 32px;
        }
        ...
        .fact-box i { color: #a855f7; font-size: 32px; flex-shrink: 0; }
        .fact-box span { font-size: 30px; color: #94a3b8; line-height: 1.4; text-align: left; }
...
<body>
    <div class="slide">
        ...
        <div class="content">
            ...
            <div class="quote-text">${d.QUOTE_TEXT}</div>
            <div class="quote-author">— ${d.QUOTE_AUTHOR}</div>
            <div class="quote-context">${d.CONTEXT}</div>
            <div class="divider"></div>
            <div class="fact-box">
                <i class="material-icons">insights</i>
                <span>${d.EXTRA_FACT}</span>
            </div>
        </div>
