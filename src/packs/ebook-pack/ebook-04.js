...
<body>
    <div class="safe-zone">
        ...
        <!-- Giant Terminal -->
        <div class="terminal-window" style="flex:1; display:flex; flex-direction:column; margin-top:20px; border-color: var(--primary-color);">
            <div class="term-header" style="justify-content: flex-start; border-bottom-color: var(--primary-color);">
                ...
                <div class="mono" style="margin-left: 12px; font-size: 28px; color: var(--text-muted);">bash/shell</div>
            </div>
            <div class="term-body" style="flex:1; display:flex; flex-direction:column; gap: 24px;">
                <div style="color: #fff;">$ <span style="color: var(--success-color);">${esc(d.COMMAND)}</span></div>
                <div style="color: var(--text-muted); font-size: 34px; white-space: pre-wrap; opacity:0.8;">${esc(d.OUTPUT)}</div>
            </div>
        </div>
