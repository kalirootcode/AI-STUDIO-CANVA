    ...
    const chartsHTML = d.STATS.map(s => `
        <div style="margin-bottom: 40px;">
            <div style="display:flex; justify-content:space-between; margin-bottom:16px;">
                <span style="font-family: var(--font-title); font-size: 30px; font-weight:700; color:#fff;">${esc(s.LABEL)}</span>
                <span style="font-family: var(--font-mono); font-size: 30px; font-weight:800; color:${s.COLOR};">${s.VALUE}%</span>
            </div>
