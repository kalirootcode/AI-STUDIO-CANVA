    ...
    const cmdsHTML = d.COMMANDS.map(c => `
        <div class="terminal-window" style="margin-bottom: 24px; box-shadow: none;">
            <div class="term-header" style="background: rgba(255,255,255,0.02); padding: 12px 20px;">
                <span class="mono" style="font-size:32px; color:var(--text-muted);"># ${esc(c.DESC)}</span>
            </div>
            <div class="term-body" style="padding: 20px; font-size: 38px;">
                $ ${esc(c.CMD)}
            </div>
        </div>
    `).join('');
...
<body>
    <div class="safe-zone">
        ...
        <div style="background: rgba(255,255,255,0.03); border-left: 3px solid var(--primary-color); padding: 20px 24px; border-radius: 0 12px 12px 0; margin-top: 20px;">
            <span style="font-family:var(--font-title); font-size: 36px; color: var(--primary-color);">💡 PRO TIP</span>
            <p class="ebook-p" style="font-size: 38px; margin-top: 12px; margin-bottom: 0;">
